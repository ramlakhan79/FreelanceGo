    ...
    <>
      <div className="section1">
        ...
        <div className="shape-img12">
          <img
            loading="lazy"
            src="https://ik.imagekit.io/bhanu1776/Freelansters/14.png?updatedAt=1682608757196"
            alt="s"
          />
        </div>
        <div className="shape-img13">
          <img
            loading="lazy"
            src="https://ik.imagekit.io/bhanu1776/Freelansters/15.png?updatedAt=1682608757177"
            alt="s"
          />
        </div>
        <div className="right">
                        ...
                        <div className="card-front">
                          <div className="center-wrap">
                            ...
                            <span className="forgot">
                              <p
                                id="Para"
                                className="py-3 mt-4 mb-0 text-center"
                              >
